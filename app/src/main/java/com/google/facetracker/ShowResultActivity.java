...
public class ShowResultActivity extends AppCompatActivity {
    ...
    public void AddValuesToPIEENTRY(){
        ...
        entries.add(new BarEntry(results[1]*100, 2));
        entries.add(new BarEntry(results[2]*100, 3));
        entries.add(new BarEntry(results[3]*100, 4));
        entries.add(new BarEntry(results[4]*100, 5));
        entries.add(new BarEntry(results[5]*100, 6));
